...
from xmuda.models.build_ssd import build_model_2d, build_model_3d
from xmuda.data.build import build_dataloader
from xmuda.data.utils.validate_ssd import validate
...
def parse_args():
    ...
    parser.add_argument(
        '--cfg',
        dest='config_file',
        default='/home/lmy/projects/xmuda1208/configs/a2d2_nuscenes/xmuda.yaml',
        metavar='FILE',
        help='path to config file',
        type=str,
    )

    parser.add_argument('--ckpt2d', type=str, help='path to checkpoint file of the 2D model', default='/data/lmy/output/a2d2_nuscenes/sse_xmuda/model_2d_095000.pth')
    parser.add_argument('--ckpt3d', type=str, help='path to checkpoint file of the 3D model', default='/data/lmy/output/a2d2_nuscenes/sse_xmuda/model_3d_090000.pth')
